...
-- Case Studies (Strict SaaS Policy)
...
-- (Similar policies for other content tables - Simplified for brevity in this master script but applying the same pattern)
-- ... [The specific policies from FIX_RLS_TABLE_NAMES.sql are applied to all content tables] ...
